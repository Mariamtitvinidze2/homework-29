...
class Person {
  ...
  const person1 = new Person("mari", 16);
...
class Person2 {
  ...
  const person2 = new Person("beqa", 19);
...
class Vehicle {
  ...
  const car2 = new Car("Tesla", 150, "Model S");
  const car3 = new Car("Ford", 100, "Focus");
...
class Character {
  ...
  const warrior1 = new Warrior("keso", 100);
  const warrior2 = new Warrior("nika", 50);
...
class Task {
  ...
  const task1 = new Task("ჯინსების თაობა", "high");
  const task2 = new Task("გადამწვარი ხიდები", "low");
  ...
  const appointment1 = new Appointment("შეყრა", "2024-02-12");
